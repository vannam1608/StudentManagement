...
namespace StudentManagementAPI.Shared
{
    public class MappingProfile : Profile
    {
     ...
     .ForMember(dest => dest.TeacherCode, opt => opt.MapFrom(src => src.TeacherCode)) // ✅ thêm dòng này
     .ForMember(dest => dest.Degree, opt => opt.MapFrom(src => src.Degree));           // ✅ và dòng này
